...
open class Easy : Difficulty {
    open var DifficultyName: String { get { return "Easy" } }
    open var STARTING_LIVES: Int { get { return 4 } }
    ...
    fileprivate var BUMBLE_MAX_VELOCITY: CGFloat { get { return CGFloat(1.0) } }
    ...
    open var CRIMINAL_RANDOM_WEAPON_VELOCITY: Bool { get { return false } }
    open var CRIMINAL_PIE_ATTACK_PERCENTAGE: Double { get { return  0.5} }
    open var CRIMINAL_BOWLING_BALL_ATTACK_PERCENTAGE: Double { get { return 0.5 } }
    open var CRIMINAL_CHICKENATOR_ATTACK_PERCENTAGE: Double { get { return 0.0 } }
    
    fileprivate var CRIMINAL_PIE_VELOCITY_MIN: CGFloat { get { return 0.2 } }
    fileprivate var CRIMINAL_PIE_VELOCITY_MAX: CGFloat { get { return 0.5 } }
    fileprivate var CRIMINAL_BOWLING_BALL_VELOCITY_MIN: CGFloat { get { return 0.2 } }
    fileprivate var CRIMINAL_BOWLING_BALL_VELOCITY_MAX: CGFloat { get { return 0.5 } }
    fileprivate var CRIMINAL_CHICKENATOR_VELOCITY_MIN: CGFloat { get { return 0.0 } }
    fileprivate var CRIMINAL_CHICKENATOR_VELOCITY_MAX: CGFloat { get { return 0.0 } }
    
    open var CRIMINAL_ALLOW_MOCKING: Bool { get { return true } }
    fileprivate var CRIMINAL_MOCKING_DISTANCE_PERCENT: CGFloat { get { return CGFloat(1.2) } }
    fileprivate var CRIMINAL_MOCKING_DISTANCE_END_PERCENT: CGFloat { get { return CGFloat(1.0) } }
    
    open var CRIMINAL_ALLOW_SECOND_WIND: Bool { get { return true } }
    fileprivate var CRIMINAL_SECOND_WIND_DISTANCE_PERCENT: CGFloat { get { return CGFloat(0.28) } }
    open var CRIMINAL_SECOND_WIND_DURATION: TimeInterval { get { return 2 } }
    open var CRIMINAL_MAX_SECOND_WINDS: Int { get { return 3 } }
    open var CRIMINAL_MAX_SECOND_WINDS_FLOOR1: Int { get { return 1 } }
    open var CRIMINAL_MAX_SECOND_WINDS_FLOOR2: Int { get { return 0 } }
    open var CRIMINAL_MAX_SECOND_WINDS_FLOOR3: Int { get { return 0 } }
    ...
    open var CRIMINAL_SECOND_WIND_CHANCE_FLOOR2: Double { get { return 0.0 } }
    open var CRIMINAL_SECOND_WIND_CHANCE_FLOOR3: Double { get { return 0.0 } }
