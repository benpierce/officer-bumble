...
open class Hard : Difficulty {
    open var DifficultyName: String { get { return "Hard" } }
    ...
    open var CRIMINAL_MAX_WEAPONS_IN_QUEUE: Int { get { return 10 } }
    ...
    open var CRIMINAL_CHICKENATOR_ATTACK_PERCENTAGE: Double { get { return 0.40 } }
    ...
    open var CRIMINAL_MAX_SECOND_WINDS: Int { get { return 4 } }
    ...
    open var CRIMINAL_SECOND_WIND_CHANCE_FLOOR3: Double { get { return 0.4 } }
