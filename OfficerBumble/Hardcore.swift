...
open class Hardcore : Difficulty {
    open var DifficultyName: String { get { return "Hardcore" } }
    open var STARTING_LIVES: Int { get { return 1 } }
    open var MAX_LIVES: Int { get { return 5 } }
    open var FREE_LIFE_SCORE: Int { get { return 15000 } }
    open var ONE_HIT_KILLS: Bool { get { return true } }
    ...
    // Criinal Constants
    fileprivate var CRIMINAL_VELOCITY: CGFloat { get { return CGFloat(0.925) } }
    open var CRIMINAL_MAX_WEAPONS_IN_QUEUE: Int { get { return 12 } }
    open  var CRIMINAL_MIN_TIME_BETWEEN_ATTACKS: TimeInterval { get { return 0.25 } }
    open var CRIMINAL_ATTACK_PERCENTAGE: Double { get { return 0.85 } }
    open var CRIMINAL_RANDOM_WEAPON_VELOCITY: Bool { get { return true } }
    open var CRIMINAL_PIE_ATTACK_PERCENTAGE: Double { get { return  0.3} }
    open var CRIMINAL_BOWLING_BALL_ATTACK_PERCENTAGE: Double { get { return 0.3 } }
    open var CRIMINAL_CHICKENATOR_ATTACK_PERCENTAGE: Double { get { return 0.4 } }
    
    fileprivate var CRIMINAL_PIE_VELOCITY_MIN: CGFloat { get { return 0.7 } }
    fileprivate var CRIMINAL_PIE_VELOCITY_MAX: CGFloat { get { return 1.80 } }
    fileprivate var CRIMINAL_BOWLING_BALL_VELOCITY_MIN: CGFloat { get { return 0.70 } }
    fileprivate var CRIMINAL_BOWLING_BALL_VELOCITY_MAX: CGFloat { get { return 1.80 } }
    fileprivate var CRIMINAL_CHICKENATOR_VELOCITY_MIN: CGFloat { get { return 0.60 } }
    fileprivate var CRIMINAL_CHICKENATOR_VELOCITY_MAX: CGFloat { get { return 1.50 } }
    ...
    fileprivate var CRIMINAL_SECOND_WIND_DISTANCE_PERCENT: CGFloat { get { return CGFloat(0.15) } }
    open var CRIMINAL_SECOND_WIND_DURATION: TimeInterval { get { return 2.5 } }
    ...
    open var CRIMINAL_SECOND_WIND_CHANCE_FLOOR1: Double { get { return 0.95 } }
    open var CRIMINAL_SECOND_WIND_CHANCE_FLOOR2: Double { get { return 0.65 } }
    open var CRIMINAL_SECOND_WIND_CHANCE_FLOOR3: Double { get { return 0.35 } }
